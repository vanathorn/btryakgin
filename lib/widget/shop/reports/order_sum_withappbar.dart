...
class OrderSumAppbar extends StatefulWidget {
  // final String shopName;
  // OrderSumAppbar({Key key, this.shopName: ''}) : super(key: key);
  @override
  _OrderSumAppbarState createState() => _OrderSumAppbarState();
}

class _OrderSumAppbarState extends State<OrderSumAppbar> {
  bool havedata = true;
