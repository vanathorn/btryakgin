...
class AppBarBrPayCart extends StatelessWidget
  ...
  AppBarBrPayCart({this.title, this.subtitle});
    ...
    return AppBar(
      ...
      actions: [
        Obx(() => Badge(
              ...
              badgeContent: Text(
                cartStateController
                    .getQuantity(mainStateController
                    ...
                    onPressed: () {
                      if (cartStateController.getQuantity(mainStateController
                        ...
                        MaterialPageRoute route = MaterialPageRoute(
                          builder: (context) =>PayCartDetailScreen(),
                        );
