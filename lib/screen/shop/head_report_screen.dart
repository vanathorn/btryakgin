...
import 'package:yakgin/widget/shop/reports/recive_sum_withappbar.dart';
import 'package:yakgin/widget/shop/reports/stockall_sum_withappbar.dart';

class HeadReportScreen extends StatefulWidget {
  HeadReportScreen({Key key}) : super(key: key);
  @override
  _HeadReportScreenState createState() => _HeadReportScreenState();
}

class _HeadReportScreenState extends State<HeadReportScreen> {
  ...
  Future<Null> getCategory() async {
    ...
    setState(() {
      ...
      fModels.name = 'รับสินค้ารายวัน (ทุกสาขา)';
      fModels.widget = ReciveSumAppbar();
    ...
    setState(() {
      ...
      fModels.name = 'สต๊อกสินค้า (ทุกสาขา)';
      fModels.widget = StockAllSumAppbar();
      listReports.add(fModels);
    });
  }
